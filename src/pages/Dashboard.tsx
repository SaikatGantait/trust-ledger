    ...
    <PageLayout>
      <div className="container px-4 py-8 md:py-12">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Here's your CredLayer overview</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="p-4 md:p-6 rounded-2xl hero-gradient text-white relative overflow-hidden">
        ...
        >
          <Card className="border-dashed border-2">
            <CardContent className="p-8 text-center">
              ...
              <Button asChild className="hero-gradient gap-2">
                <Link to="/borrow">
