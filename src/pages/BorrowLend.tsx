      ...
      <div className="container px-4 py-8 md:py-12">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="grid w-full max-w-md grid-cols-2 h-14">
            <TabsTrigger value="borrow" className="gap-2 h-12 text-base">
              <CreditCard className="h-4 w-4" />
              Borrow
            </TabsTrigger>
            <TabsTrigger value="lend" className="gap-2 h-12 text-base">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {[
                      ...
                      <div key={item.step} className="p-4 rounded-xl bg-muted">
                        <div className="flex items-start gap-3">
