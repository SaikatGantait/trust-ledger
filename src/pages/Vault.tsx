        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            <Card className="overflow-hidden border-2 shadow-lg">
              <div className="vault-gradient text-white p-8">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div className="font-mono text-sm mt-2 bg-white/10 rounded-lg px-3 py-2">
                    0x7F5E...8A3D
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-center justify-between gap-4 flex-wrap">
                    ...
                    <div className="flex-1 min-w-[60px] max-w-[120px] relative">
                      <div className="h-1 bg-gradient-to-r from-primary to-accent rounded-full overflow-hidden">
                        <div className="h-full w-1/3 bg-white/50 animate-flow-right" />
                      </div>
                    ...
                    {/* Deposit Wallet */}
                    <div className="flex flex-col items-center gap-2">
                      <div className="w-16 h-16 rounded-2xl vault-gradient flex items-center justify-center relative">
          ...
          >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <Button className="w-full h-12 hero-gradient gap-2" disabled>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      CredLayer will never ask for your private keys.
                    </p>
                  </div>
                </div>
              </CardContent>
